...
{
    public partial class AgriculturalMaterialDBContext : DbContext
    {
        public AgriculturalMaterialDBContext()
        {
        }

        public AgriculturalMaterialDBContext(DbContextOptions<AgriculturalMaterialDBContext> options)
            : base(options)
        {
        }
